...
The Pipeline CRD: a credential-free wiring layer binding N signal sources and M channels to one profile, with pipeline-only routing resolution, and at-most-one-pipeline-per-source claiming.
