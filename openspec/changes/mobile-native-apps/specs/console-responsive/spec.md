...
The console frontend renders on a narrow viewport: the navigation can be put
away, a table becomes a list of labelled cards, and no page scrolls sideways.
This is a foundation `console-native-shell` builds on, not an alternative to
it — the same frontend bundle is what the native apps wrap.
