## Purpose
While a node is deliberately being taken out of service, the events its workloads emit describe the drain and not a fault; the adapter suppresses them for exactly as long as the drain lasts and reports a drain that lasts too long.
