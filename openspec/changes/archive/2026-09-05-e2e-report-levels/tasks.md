...
- [x] 1.1 Write `.github/scripts/e2e-report.py`: parse a `go test -json`
...
- [x] 1.2 Handle zero parseable test events (a build failure, or any file
...
- [x] 2.1 In `.github/workflows/e2e.yml`'s "Run the pack" step: create
...
- [x] 2.2 Add a step after "Run the pack", `if: always()`, that runs
...
- [x] 3.1 Add `.github/tests/e2e-report.test.sh`, following
...
- [x] 3.2 Verify `.github/tests/run.sh` picks the new test up (it globs
...
- [x] 4.1 Not applicable — nothing in this change is decided by a
...
- [x] 5.1 Reference docs: update `docs/testing.md` — the "What the
      ...
      `e2e.yml`.
- [x] 5.2 Adopter site: none of the site's pages (landing page, Introduction,
