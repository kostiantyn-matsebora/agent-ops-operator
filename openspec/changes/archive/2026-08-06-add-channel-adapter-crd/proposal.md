...
- Live install (home-data-center): `home-ops` Channel gains `credentialsSecretRef: agentops-telegram`; adapter workload ownership moves from helm to the reconciler (upgrade must avoid a double-getUpdates window).
