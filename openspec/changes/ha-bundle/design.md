...
3. gitops: unchanged by default; adoption per D4(b) if/when wanted. Rollback = disable the flag (helm removes bundle-owned CRs; hand-applied ones are untouched).
