...
- Live install caveat: gitops already runs these CRs kubectl-applied under the same intent — enabling the bundle there requires an adoption step (helm ownership) or keeping it disabled; documented in the migration plan.
