...
- Chat **HTML** subset only: `<b>`, `<i>`, `<code>`, `<pre>`, `<a href>`. No markdown (`**`, `#`, backticks). Your printed answer is posted to chat verbatim by the operator, so write it as the chat message.
